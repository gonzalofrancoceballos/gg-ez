...
from gg_ez import __version__ as release
...
latex_documents = [
    (master_doc, "gg_ez.tex", "gg_ez Documentation", "QuantumBlack", "manual",)
]
...
man_pages = [(master_doc, "gg_ez", "gg_ez Documentation", [author], 1,)]
